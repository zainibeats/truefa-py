...
def main():
    ...
    # Hash the password - IMPORTANT: Store as hex string, not base64!
    ...
    # Convert the hash to hex (to match what PythonCrypto.create_vault does)
    ...
    # This matches what PythonCrypto.encrypt_master_key does
